...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<div class="col-sm-4 col-xs-6">
      	...
      	<div class="panel panel-default">
          <div class="panel-thumbnail"><a onClick="location.href= \'images/'.$row['imgsrc'].'\'" href="images/'.$row['imgsrc'].'" title="'.$row['about'].'"><img src="images/'.$row['imgsrc'].'" class="img_gal_format1" width="100%"></a></div>
